...
for (const adminID of config.adminBot) {
	api.sendMessage(msg, adminID);
		...
		const notifyMsg = `✅Your approval request for using Bot's main cmds has been sent to admin Gabyu with this\nmessage: ${userMessage}.\n\n I will notify you if your thread is approved. Please wait until then.\n\n join the Gojo Educ Gc support Box if you facing any problem\nType : /support \nto join.`;
