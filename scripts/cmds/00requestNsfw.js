...
for (const adminID of config.adminBot) {
	api.sendMessage(msg, adminID);
		...
		const notifyMsg = `✅Your approval request has been sent to admin Gab Yu with this\nmessage: ${userMessage}.\n\n I will notify you if your thread is approved. Please wait until then.\n\n join the Gojo Educ Gc support box for fast approve \ntype : /support\nto join`;
